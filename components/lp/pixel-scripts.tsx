...
export function PixelScripts({ pixels }: PixelScriptsProps) {
  return (
    <>
      ...
      {pixels.googleTagId && (
        <>
          <Script src={`https://www.googletagmanager.com/gtag/js?id=${pixels.googleTagId}`} strategy="afterInteractive" />
      ...
      {pixels.tiktokPixelId && (
        <Script id="tiktok-pixel-base" strategy="afterInteractive">
          {`!function (w, d, t) {
            ...
            o.async=!0;o.src=i+"?sdkid="+e+"&lib="+t;var a=d.getElementsByTagName("script")[0];a.parentNode.insertBefore(o,a)};
            ttq.load('${pixels.tiktokPixelId}');ttq.page();
          }(window, document, 'ttq');`}
        </Script>
      )}
    </>
