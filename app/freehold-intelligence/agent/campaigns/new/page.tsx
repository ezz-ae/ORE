...
export default function BrokerNewCampaignPage() {
        ...
        {STEPS.map((s, i) => {
          ...
          return (
            <div key={s.n} className="flex flex-1 items-center">
              ...
              <span className={`ml-2 hidden text-sm font-medium sm:block ${active ? 'text-white' : done ? 'text-gold/70' : 'text-slate-600'}`}>
                {s.label}
              </span>
              {i < STEPS.length - 1 && (
        ...
        {step === 4 && (
          <div className="space-y-6">
            ...
            <div className="rounded-[16px] border border-line bg-surface-2 p-5">
              <div className="mb-3 text-xs font-medium uppercase tracking-[0.18em] text-slate-500">Creative preview</div>
