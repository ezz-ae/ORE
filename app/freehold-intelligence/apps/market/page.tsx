    ...
    <div className="mx-auto max-w-7xl px-4 pb-16 pt-6 sm:px-6 sm:pt-8 lg:pt-16">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-800 bg-slate-800/50 py-2.5 pl-9 pr-9 text-sm text-slate-200 placeholder:text-slate-600 focus:border-[#D4AF37]/40 focus:outline-none"
            />
            {query && (
          ...
          <select
            ...
            className="rounded-xl border border-slate-800 bg-slate-800/50 px-3.5 py-2.5 text-sm text-slate-300 focus:border-[#D4AF37]/40 focus:outline-none"
          >
      ...
      <section className="mt-5">
        <div className="overflow-hidden rounded-[24px] border border-slate-800 bg-slate-900">
          {/* Table header */}
          <div className="hidden grid-cols-[2fr_1fr_1fr_0.8fr_2fr_auto] gap-4 border-b border-slate-800 px-6 py-3.5 lg:grid">
            {[
              ...
              filtered.map((project) => {
                ...
                return (
                  <Link
                    ...
                    className="group flex flex-col gap-3 px-5 py-4 transition hover:bg-slate-800/30 lg:grid lg:grid-cols-[2fr_1fr_1fr_0.8fr_2fr_auto] lg:items-center lg:gap-4 lg:px-6 lg:py-4"
                  >
                    <div className="min-w-0">
                      <p className="truncate text-sm font-semibold text-white transition-colors group-hover:text-[#D4AF37]">
                        {project.projectName}
                      </p>
                    ...
                    <ArrowUpRight className="hidden h-4 w-4 text-slate-600 transition group-hover:text-[#D4AF37] lg:block" />
                  </Link>
                )
              })
            )}
      ...
      <section className="mt-10 rounded-[20px] border border-[#D4AF37]/15 bg-[#D4AF37]/[0.04] px-6 py-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-[#D4AF37]/80">Internal use only</p>
