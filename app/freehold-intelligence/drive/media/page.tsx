...
export default function MediaEditorPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-16 pt-5 sm:px-6">
      ...
      <h1 className="text-lg font-semibold text-white">{t('med.title')}</h1>
      ...
      <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
        ...
        <Card href="/freehold-intelligence/drive/library" Icon={Video} accent="text-teal-300 border-teal-400/25 bg-teal-400/[0.06]" appKey="video" />
      </div>
    </div>
  )
}
