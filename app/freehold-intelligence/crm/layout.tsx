            ...
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  {tab.label}
                  {tab.label === 'Agents' && (
                    <span className="ml-auto text-[10px] font-semibold text-[#D4AF37]/60">3</span>
                  )}
                </Link>
              )
            })}
                ...
                return (
                  <Link
                    ...
                    className={[
                      ...
                      active ? 'border-[#D4AF37] text-white' : 'border-transparent text-white/40 hover:text-white/65',
                    ].join(' ')}
                  >
                    {tab.label}
                  </Link>
