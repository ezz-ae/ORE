  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <header className="sticky top-0 z-40 flex h-14 shrink-0 items-center gap-3 border-b border-white/[0.07] bg-[#0B0F1A]/95 px-4 backdrop-blur-xl sm:px-6">
        ...
        <div className="ml-auto text-[12px] text-white/25">8 connected · 2 pending</div>
      </header>
                ...
                return (
                  <Link
                    ...
                    className={[
                      ...
                      active ? 'border-white/40 text-white' : 'border-transparent text-white/40 hover:text-white/65',
                    ].join(' ')}
                  >
                    {tab.label}
                  </Link>
