          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-[10px] border border-line bg-surface-2 px-3 py-2.5 pe-9 font-mono text-sm text-white placeholder-white/20 outline-none focus:border-emerald-400/40"
              />
