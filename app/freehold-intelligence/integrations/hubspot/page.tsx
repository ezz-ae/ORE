      ...
      <div className="mb-7 flex items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-xl font-semibold tracking-tight text-white sm:text-2xl">{t('pinthub.title')}</h1>
          </div>
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              <input
                ...
                className="w-full rounded-[10px] border border-line bg-surface-2 px-3 py-2.5 pe-9 font-mono text-sm text-white placeholder-white/20 outline-none focus:border-orange-400/40"
              />
