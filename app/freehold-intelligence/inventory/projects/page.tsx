...
function devColor(name: string) {
  return DEV_COLORS[name] ?? 'bg-slate-800/50 text-slate-400'
}
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 pb-20 pt-7 sm:px-8">
      ...
      <div className="mb-7">
        ...
        <p className="mt-1 text-xs text-slate-500">All properties grouped by developer</p>
      </div>
      ...
      <div className="space-y-2">
        {developers.map(([developer, props]) => {
          ...
          return (
            <div key={developer} className="rounded-[16px] border border-slate-800 bg-slate-900 overflow-hidden">
