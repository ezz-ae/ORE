      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[380px_1fr]">
        ...
        <div className="space-y-5">
          ...
          <button
            ...
            className="w-full rounded-full bg-[#D4AF37] px-5 py-3 text-[14px] font-semibold text-[#06080A] transition hover:bg-[#F8E7AE] disabled:opacity-50"
          >
            {loading ? (
          ...
          {error && (
            <p className="rounded-[12px] border border-red-400/20 bg-red-400/[0.05] px-4 py-3 text-[12px] text-red-400">
              {error}
            </p>
          )}
        </div>
        ...
        <div>
          {variants.length === 0 && !loading && (
            <div className="flex h-full min-h-[320px] flex-col items-center justify-center rounded-[24px] border border-dashed border-white/[0.07] text-center">
              <Wand2 className="mx-auto h-8 w-8 text-white/15 mb-3" />
              <div className="text-[14px] text-white/30">Configure options and generate</div>
          ...
          {loading && (
            <div className="flex h-full min-h-[320px] flex-col items-center justify-center gap-3">
              ...
              <div className="text-[13px] text-white/35">Building copy variants…</div>
            </div>
          )}
          ...
          {variants.length > 0 && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Link
                  href={campaignNewUrl}
                  className="inline-flex items-center gap-1.5 rounded-full bg-[#D4AF37] px-4 py-1.5 text-[12px] font-semibold text-[#06080A] transition hover:bg-[#F8E7AE]"
                >
                  Use in campaign
                </Link>
              </div>
