...
export default function GoogleCampaignDetailPage({
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-16 pt-6 sm:px-6 sm:pt-8">
      ...
      {/* ── Config error ───────────────────────────────────────────────────── */}
      {!loading && configErr && (
        <div className="mt-10 rounded-[20px] border border-line bg-surface-2 p-5 sm:p-6">
      ...
      {!loading && error && !configErr && (
        <div className="mt-10 rounded-[18px] border border-line bg-surface-2 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              {campaignId && (
                <button
                  ...
                  className="mt-2 text-xs text-[#4285F4]/70 transition hover:text-[#4285F4]"
                >
                  Try again
                </button>
              )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        <span
                          className={`rounded-full border px-2.5 py-0.5 text-xs font-semibold ${strengthCls}`}
                        >
                          {ad.adStrength}
                        </span>
                        <span
                      ...
                      {/* Headlines */}
                      <div className="mt-4">
                        <div className="mb-2 text-xs font-medium uppercase tracking-[0.16em] text-slate-600">
                          Headlines
                        </div>
                      ...
                      {finalUrl && (
                        <div className="mt-4 flex items-center gap-2">
                          ...
                          <a
                            ...
                            className="max-w-xs truncate text-xs text-[#4285F4]/70 transition hover:text-[#4285F4]"
                          >
                            {finalUrl}
                          </a>
                        </div>
