...
export default function GoogleKeywordsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-16 pt-6 sm:px-6 sm:pt-8">
      ...
      {/* ── Loading ── */}
      {loading && (
        <div className="mt-12 text-center text-[14px] text-white/35">Loading keywords…</div>
      )}
            ...
            {(['ALL', 'BROAD', 'PHRASE', 'EXACT'] as MatchFilter[]).map((f) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-[10px] px-3.5 py-1.5 text-[12px] font-medium transition ${
                    matchFilter === f
            ...
            <div className="mt-4 overflow-hidden rounded-[20px] border border-white/[0.08] bg-[#131B2B]">
              ...
              <div className="divide-y divide-white/[0.035]">
                {filtered.map((kw) => (
                  <div
                    key={kw.id}
                    className="grid grid-cols-[1fr_100px_140px_80px_72px_80px_80px_40px] items-center gap-x-3 px-5 py-3 text-[12px] transition hover:bg-white/[0.015]"
                  >
                ...
                <div className="mt-1 overflow-hidden rounded-[16px] border border-white/[0.08] bg-[#131B2B]">
                  ...
                  <div className="divide-y divide-white/[0.04]">
                    {negatives.map((neg) => (
                      <div
                        key={neg.id}
                        className="grid grid-cols-[1fr_80px_120px] items-center gap-x-3 px-5 py-2.5 text-[12px]"
                      >
                ...
                >
                  ...
                  <div className="relative mt-1 flex justify-end">
                    <div className="group relative">
                      <button
                        disabled
                        className="inline-flex cursor-not-allowed items-center gap-1.5 rounded-[10px] border border-white/[0.08] bg-white/[0.03] px-3 py-1.5 text-[12px] text-white/30"
                      >
                        Add to campaign
                      </button>
                      {/* Tooltip */}
