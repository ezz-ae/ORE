  ...
  return (
    <div className="mx-auto max-w-5xl px-6 pb-16 pt-6 sm:pt-16">
      ...
      <section className="mt-20">
        ...
        <div className="mt-7 grid gap-3">
          {INFRA.map((i) => {
            ...
            return (
              <div key={i.label} className="flex items-center justify-between gap-5 rounded-2xl border border-slate-800 bg-slate-900 p-5">
      ...
      <section className="mt-20">
        ...
        <div className="mt-7 overflow-hidden rounded-3xl border border-slate-800 bg-slate-900">
          {audit.length === 0 ? (
