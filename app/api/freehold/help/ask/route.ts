...
- Ads / Lead Machine: /lead-machine (hub), /lead-machine/campaigns/new (Meta campaign wizard: project → creative → budget/audience → launch), /lead-machine/creatives + /lead-machine/creatives/generate (AI ad copy), /lead-machine/forms (Meta lead forms), /lead-machine/google/campaigns/new (Google search campaign), /lead-machine/google/keywords, /lead-machine/targeting
- Ads Live: /ads-live (real-time spend & leads overview), /ads-live/meta, /ads-live/google, /ads-live/preview
- Inventory: /inventory (all projects), /inventory/projects (grouped by developer), /inventory/landings (create + publish landing pages at /lp/<slug>, per-row Campaign button prefills the ad builder), open a project to generate a landing page or start a campaign
