    ...
    try {
      ...
      const fallbackContent = isUnauthorized
        ...
        : mode === 'broker'
          ...
          : `I'm having trouble connecting right now. Tell me your budget, preferred area, and unit type, then share your name + phone so a ${BRAND.company} advisor can send a tailored shortlist.`
