...
const en: Dict = {
  ...
  'coach.common.expert.body': 'Your AI partner reads the live system. Ask it to plan, draft a campaign, design a landing page or review work — it answers right here, grounded in your real data. Press ⌘J / Ctrl-J anytime.',
...
const ar: Dict = {
  ...
  'coach.common.expert.body': 'مساعدك الذكي يقرأ حالة النظام مباشرة. اطلب منه التخطيط أو صياغة حملة أو تصميم صفحة هبوط أو مراجعة العمل — يجيبك هنا مباشرةً بالاعتماد على بياناتك الفعلية. اضغط ⌘J / Ctrl-J في أي وقت.',
...
const ru: Dict = {
  ...
  'coach.common.expert.body': 'Ваш ИИ-помощник читает систему в реальном времени. Попросите его спланировать, составить кампанию, оформить лендинг или проверить работу — он ответит прямо здесь на основе ваших реальных данных. Нажмите ⌘J / Ctrl-J в любой момент.',
