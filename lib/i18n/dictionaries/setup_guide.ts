...
const en: Dict = {
  ...
  'howto.sendCash.name': 'Send Cash to someone',
  'howto.sendCash.s1': 'Open your Wallet — the big number is what you can spend right now.',
  'howto.sendCash.s2': 'Press Send, then pick the person or paste their account number.',
  'howto.sendCash.s3': 'Enter the amount and send. It is in their wallet immediately, and on both of your histories.',
  'howto.topUpCash.name': 'Record money you paid the company',
  'howto.topUpCash.s1': 'Transfer the money to the company account first — this only records it.',
  'howto.topUpCash.s2': 'Open your Wallet and press Top up.',
  'howto.topUpCash.s3': 'Enter the amount and the transaction number from your transfer. It becomes spendable Cash once finance matches it against the statement.',
...
const ar: Dict = {
  ...
  'howto.sendCash.name': 'إرسال كاش لشخص ما',
  'howto.sendCash.s1': 'افتح محفظتك — الرقم الكبير هو ما يمكنك إنفاقه الآن.',
  'howto.sendCash.s2': 'اضغط «إرسال»، ثم اختر الشخص أو ألصق رقم حسابه.',
  'howto.sendCash.s3': 'أدخل المبلغ وأرسل. يصل إلى محفظته فوراً، ويظهر في سجلّيكما معاً.',
  'howto.topUpCash.name': 'تسجيل مبلغ دفعته للشركة',
  'howto.topUpCash.s1': 'حوّل المبلغ إلى حساب الشركة أولاً — هذه الخطوة تسجّله فقط.',
  'howto.topUpCash.s2': 'افتح محفظتك واضغط «شحن».',
  'howto.topUpCash.s3': 'أدخل المبلغ ورقم عملية التحويل. يصبح كاشاً قابلاً للإنفاق بمجرد مطابقة المالية له مع كشف الحساب.',
...
const ru: Dict = {
  ...
  'howto.sendCash.name': 'Отправить кэш человеку',
  'howto.sendCash.s1': 'Откройте Кошелёк — большое число это то, что можно потратить сейчас.',
  'howto.sendCash.s2': 'Нажмите «Отправить» и выберите человека или вставьте номер его счёта.',
  'howto.sendCash.s3': 'Укажите сумму и отправьте. Деньги сразу у получателя, и запись есть у вас обоих.',
  'howto.topUpCash.name': 'Записать деньги, внесённые компании',
  'howto.topUpCash.s1': 'Сначала переведите деньги на счёт компании — здесь они только записываются.',
  'howto.topUpCash.s2': 'Откройте Кошелёк и нажмите «Пополнить».',
  'howto.topUpCash.s3': 'Укажите сумму и номер операции вашего перевода. Кэшем это станет после сверки финансами с выпиской.',
